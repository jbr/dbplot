...
I'd also like to figure out how to really lock down the security so this can be run in a sandbox through a web interface; users could type in queries and get plots back against a database.