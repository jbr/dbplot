...
This would generate and execute a MySQL query, pass it to R, and use ggplot2 to generate the appropriate plot.  The eventual plan is to support as much of common interactions between a database and ggplot2, including joins, faceting, grouping, coloring, summarization, different geoms, etc.